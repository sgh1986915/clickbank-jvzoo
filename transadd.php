...
if(isset($_POST['txtClick'])){
	...
	if(strlen($Pccustemail) > 0 && strlen($Pccustname) > 0){
		...
		//if(strlen( $Receipt->Name)>0){
			$Id = $Receipt->AddReceipt($Pccustname,$Pccustemail,$Pctransreceipt,"","","","",$prodid,$today,"","","","","","","","","");
			...
			exit;
		//}else{
		//$Error = "Transaction Id not recognised.";
		//}
	}
}
?>
...
<link href="styles/print.css" rel="stylesheet" type="text/css" media="print" />
		...
		function Validate(objForm){
			...
			if(objForm.txtClick.value==""){
				...
				alert("Please enter a value for Clicksure transaction id");
				return false;
			}
...
<div class="wrapper">
	...
	<td width="30%" align="right">
		...
		<tr>
	<td width="30%" align="right">
		Clicksure transaction Id </td>
		<td><input type="text" name="txtClick" id="txtClick" size="35" maxlength="255" tabindex="2">
		</td></tr>
		<tr>
	<td width="30%" align="right">
		Product Id </td>
		<td><input type="text" name="txtProdId" id="txtProdId" size="35" maxlength="255" tabindex="3">
		</td></tr>
		<tr>
	<td width="30%" align="right">
		Email </td>
		<td><input type="text" name="txtEmail" id="txtEmail" size="35" maxlength="255" tabindex="4">
		</td></tr>
		<tr>
